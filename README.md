...
This is a research tool, not advice. There is a backtest — three rankings over
47 monthly entries since September 2022, and four reasons it proves less than it
looks like, all set out on the page — but no track record. Selling puts on stocks that have fallen means
